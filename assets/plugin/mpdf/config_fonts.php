...
$this->fontdata = array(
/* Font Certificate */
	"aspiredemibold" => array(
		'R' => "Aspire-DemiBold.ttf",
        'B' => "Aspire-DemiBold.ttf",
        'I' => "Aspire-DemiBold.ttf",
	),

	"kelveticanobis" => array(
		'R' => "Courier Prime Sans.ttf",
        'B' => "Courier Prime Sans Bold.ttf",
        'I' => "Courier Prime Sans Italic.ttf",
        'BI' => "Courier Prime Sans Bold Italic.ttf"
	),
