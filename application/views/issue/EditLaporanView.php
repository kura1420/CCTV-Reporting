<div class="row">
  ...
  <div class="col-xs-12">
    ...
    <?=form_open_multipart("issue/laporan/" . $row->issue_id, array('class' => 'form-horizontal'))?>
...
<?=$this->dswitch->statusPriority($row->issue_priority)?>
            ...
            <div style="color: red;"><?=form_error('issue_notecctv')?></div>
                  ...
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Management Konfirmasi</label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Management Konfirmasi" value="<?=$row->issue_management?>" name="issue_management" readonly="readonly">
                      <div style="color: red;"><?=form_error('issue_management')?></div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control" rows="8" name="issue_notemanagement" readonly><?=$row->issue_notemanagement?></textarea>
            <div style="color: red;"><?=form_error('issue_notemanagement')?></div>
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Keterangan Laporan</label>
                    <div class="col-sm-8">
                      <textarea class="form-control editor1" rows="8" name="issue_notelaporan"></textarea>
            <div style="color: red;"><?=form_error('issue_notelaporan')?></div>
                    </div>
                  </div>
