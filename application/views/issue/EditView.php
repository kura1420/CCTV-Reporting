<div class="row">
  ...
  <div class="col-xs-12">
    ...
    <?=form_open_multipart("issue/konfirmasi/" . $row->issue_id, array('class' => 'form-horizontal'))?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      ...
                      echo form_dropdown('issue_priority', $options, '', 'class="form-control"');
                      ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control editor1" rows="8" name="issue_notecctv"></textarea>
