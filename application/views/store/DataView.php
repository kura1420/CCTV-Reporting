<div class="row">
  <div class="col-xs-12">
    ...
    <h3 class="header smaller lighter blue"><?=ucfirst($this->page)?>
      <button onClick="location.href='<?=base_url("store")?>'" class="btn btn-minier btn-info"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</button>
      <button onClick="location.href='<?=base_url("store/perbarui/" . $row->store_id)?>'" class="btn btn-minier btn-warning"><span class="glyphicon glyphicon-edit"></span> Perbarui</button></h3>
