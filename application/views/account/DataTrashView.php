<div class="row">
  <div class="col-xs-12">
    ...
    <h3 class="header smaller lighter blue"><?=ucfirst($this->page)?>
      <button onClick="location.href='<?=base_url("dataterhapus/pengguna")?>'" class="btn btn-minier btn-info"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</button>
    </h3>
    ...
    <div>
                            ...
                            <div class="profile-info-row">
    													...
    													<div class="profile-info-value">
    														<span class="editable" id="username"><?php if ($row->update_date != '0000-00-00 00:00:00'): echo $row->delete_date; endif;?></span>
    													</div>
    												</div>
